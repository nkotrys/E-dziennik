...
class ZobaczPlanRodzic: AppCompatActivity() {
...
// Create an ArrayAdapter using the string array and a default spinner layout.
    ...
    fun onClickWyswietl(v: View) {
        ...
        zapytanie.put("query","SELECT * FROM plan_lekcji WHERE dzien_tygodnia = '$dzien' AND klasa = (SELECT klasa FROM uczen_klasa WHERE id_ucznia = (SELECT id_ucznia FROM uczen_rodzic WHERE id_rodzica = (select id from users where username = \"${MainActivity.username}\")));")
